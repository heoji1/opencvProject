...
//	Mat input = imread("lena.jpg", IMREAD_COLOR);
	...
	//Fill the code/////////////////////////////////////
  	...
  	int kSize = 3;
  	double k = 0.04;
  	cornerHarris(input_gray, output, blockSize, kSize, k, BORDER_DEFAULT);
	////////////////////////////////////////////////////


	//Scale the Harris response map 'output' from 0 to 1.
	//This is for display purpose only.
	normalize(output, output_norm, 0, 1.0, cv::NORM_MINMAX);
	...
	if (NonMaxSupp)
	{
		NonMaximum_Suppression(output, corner_mat, 5);
